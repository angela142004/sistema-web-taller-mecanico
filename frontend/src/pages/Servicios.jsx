    ...
    return (
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 py-16">
            ...
            <p className="max-w-3xl mx-auto text-gray-300 text-base md:text-lg leading-relaxed">
                ...
                vehículos: mantenimiento preventivo, diagnóstico avanzado, reparaciones
                especializadas y venta de repuestos. Atención profesional y garantía en
                cada servicio.
            </p>
            </header>
            ...
            <h2 className="text-2xl font-semibold mb-6 text-white/90">Servicios destacados</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                >
                    ...
                    <h3 className="text-lg md:text-xl font-bold mb-2">{d.titulo}</h3>
                    <p className="text-gray-300 text-sm md:text-base">{d.descripcion}</p>
                </article>
                ))}
            </div>
            </section>
            ...
            <section>
            <h2 className="text-2xl font-semibold mb-6 text-white/90">Todos nuestros servicios</h2>
